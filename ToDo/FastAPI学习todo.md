...
## 一、必学（核心 12 项，约 3–4 天）

### 第一组：写一个接口（输入 → 输出）



* [x] **1. 第一步** — [https://fastapi.tiangolo.com/zh/tutorial/first-steps/](https://fastapi.tiangolo.com/zh/tutorial/first-steps/)

- 学什么：装 FastAPI、写第一个 `GET /`、`fastapi dev` 启动

- 验收：浏览器打开 [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs) 能看到自动生成的接口文档（Swagger）

* [x] **2. 路径参数** — [https://fastapi.tiangolo.com/zh/tutorial/path-params/](https://fastapi.tiangolo.com/zh/tutorial/path-params/)
...
- 验收：`GET /chat/history/{session_id}` 传 0 或负数，看自动报错

* [x] **3. 查询参数** — [https://fastapi.tiangolo.com/zh/tutorial/query-params/](https://fastapi.tiangolo.com/zh/tutorial/query-params/)
...
- 验收：`session_id` 传空串时看自动报错

* [x] **4. 请求体（Pydantic）⭐ 最重要** — [https://fastapi.tiangolo.com/zh/tutorial/body/](https://fastapi.tiangolo.com/zh/tutorial/body/)
...
* [ ] **9. CORS 跨域** — [https://fastapi.tiangolo.com/zh/tutorial/cors/](https://fastapi.tiangolo.com/zh/tutorial/cors/)
...
* [ ] **10. 测试** — [https://fastapi.tiangolo.com/zh/tutorial/testing/](https://fastapi.tiangolo.com/zh/tutorial/testing/)

- 学什么：`TestClient(app)` + pytest，不用起服务器就能测

- 验收：至少 3 个用例 —— 正常问答、参数缺失报错、模型失败时的错误返回

* [ ] **11. 部署启动** — [https://fastapi.tiangolo.com/zh/tutorial/deployment/](https://fastapi.tiangolo.com/zh/tutorial/deployment/)
...
* [ ] **流式输出（StreamingResponse）** — 进阶指南 [https://fastapi.tiangolo.com/zh/advanced/websockets/](https://fastapi.tiangolo.com/zh/advanced/websockets/) 附近（搜 "StreamingResponse"）

- 什么时候学：模型对话接口要 "打字机效果" 时 ——**强烈建议必学完成后立刻补**，LLM 应用面试常问

* [ ] **请求体嵌套模型** — [https://fastapi.tiangolo.com/zh/tutorial/body-nested-models/](https://fastapi.tiangolo.com/zh/tutorial/body-nested-models/)

- 什么时候学：**阶段 2 RAG** 接口要传 `{query: str, filters: {...}, top_k: int}` 这种复杂结构时

* [ ] **静态文件** — [https://fastapi.tiangolo.com/zh/tutorial/static-files/](https://fastapi.tiangolo.com/zh/tutorial/static-files/)

- 什么时候学：想给项目配一个简单网页演示时

* [ ] **后台任务** — [https://fastapi.tiangolo.com/zh/tutorial/background-tasks/](https://fastapi.tiangolo.com/zh/tutorial/background-tasks/)

- 什么时候学：想异步存对话历史、发日志不阻塞接口时

* [ ] **项目拆文件** — [https://fastapi.tiangolo.com/zh/tutorial/bigger-applications/](https://fastapi.tiangolo.com/zh/tutorial/bigger-applications/)

- 什么时候学：单文件超过 300 行、想按模块组织时

* [ ] **中间件** — [https://fastapi.tiangolo.com/zh/tutorial/middleware/](https://fastapi.tiangolo.com/zh/tutorial/middleware/)
...
* ❌ **查询请求模型（Query Params as a Pydantic Model）** — 把模型当查询参数用的写法，项目用不到

* ❌ **声明请求示例数据（Declare Request Example Data）** — 直接用 /docs 的 "Try it out" 调试，比手写 example 更省事

* ❌ **额外数据类型（Extra Data Types）** — UUID /datetime 等高级类型暂时用不上
